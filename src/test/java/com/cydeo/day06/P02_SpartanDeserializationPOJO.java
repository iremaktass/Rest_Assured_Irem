...
public class P02_SpartanDeserializationPOJO extends SpartanTestBase {
    ...
    public void test3() {
        ...
        List<Spartan> allContent = search.getContent();

        //print second spartan from  content
        System.out.println( search.getContent().get(1));
        //OR
        System.out.println(allContent.get(1));

        ///get me second spartan name
        System.out.println(search.getContent().get(1).getName());
    ...
    public void test4() {
        ...
        for (Spartan allSpartan : allSpartans) {
            System.out.println(allSpartan);
        }

        System.out.println(allSpartans.get(1).getId());
